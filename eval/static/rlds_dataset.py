...
class RLDSBatchTransform:
    ...
    perturbation: Optional[torch.Tensor] = None  # Optional perturbation to apply to images
    ...
    def __call__(self, rlds_batch: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if self.perturbation != None:
            ...
            img = Image.fromarray(apply_perturbation([img], self.perturbation)[0])
