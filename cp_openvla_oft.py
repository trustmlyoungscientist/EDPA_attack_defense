...
from utils.openvla_oft import build_prompt
# Sane Defaults
...
class FinetuneConfig:
    # fmt: off
    model_family: str = "openvla-oft"                                 # Model family (selects EDPA branch)
    vla_path: str = "moojink/openvla-7b-oft-finetuned-libero-spatial-object-goal-10"  # OpenVLA-OFT checkpoint (HF Hub)
    # Directory Paths
    ...
    perturbation_ratio: float = 0.05                                 # Ratio of perturbation to apply
    ...
    save_path: str = "perturbation/openvla-oft"                     # Path to save perturbations
    ...
    wandb_project: str = "openvla-oft"                              # Name of W&B project to log to
    wandb_entity: str = ""                                          # Name of entity to log under
    run_id_note: Optional[str] = None                               # Extra note for logging, Weights & Biases
    camera_view: str = "primary"                                    # Camera view to use: primary | wrist | random
...
def train_up(cfg: FinetuneConfig) -> None:
    ...
    # Load OpenVLA-OFT Processor and Model using HF AutoClasses
