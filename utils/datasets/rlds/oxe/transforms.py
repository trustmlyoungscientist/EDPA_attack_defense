...
from utils.datasets.rlds.oxe.utils.droid_utils import droid_baseact_transform, droid_finetuning_transform
from utils.datasets.rlds.utils.data_utils import (
...
def uoa_orig_dataset_transform(trajectory: Dict[str, Any]) -> Dict[str, Any]:
    """
...
def pnp_4diverse_png_transform(trajectory: Dict[str, Any]) -> Dict[str, Any]:
    """No-op transform for our ALOHA-style trossen data. Action is already
    absolute 7-DoF joint targets and state is already the same 7-DoF joint
    reading -- nothing to standardize.
    """
    return trajectory
...
OXE_STANDARDIZATION_TRANSFORMS = {
    ...
    "uoa_orig": uoa_orig_dataset_transform,
    ...
    ### Trossen (ALOHA-style, JOINT_POS absolute)
    "pnp_4diverse_png": pnp_4diverse_png_transform,
}
