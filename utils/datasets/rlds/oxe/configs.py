...
OXE_DATASET_CONFIGS = {
    ...
    "pnp_4diverse_png": {
        # UoA-Trossen-Arm/pick_and_place_4_object_diverse: 4 sub-datasets merged
        # (carrot / pineapple / starfruit / strawberry, 400 eps, 4 tasks).
        # ALOHA-style JOINT_POS (7 dims absolute), PNG-encoded, forge-emitted
        # per-frame language_instruction. Matches the recipe our production
        # OFT / pi0 / vanilla-openvla ckpts were finetuned on.
        "image_obs_keys": {"primary": "cam_main_image", "secondary": None, "wrist": "cam_wrist_image"},
        "depth_obs_keys": {"primary": None, "secondary": None, "wrist": None},
        "state_obs_keys": ["state"],
        "state_encoding": StateEncoding.JOINT,
        "action_encoding": ActionEncoding.JOINT_POS,
